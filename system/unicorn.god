...
God.watch do |w|
  ...
  w.start = "cd #{rails_root} && /usr/local/ruby-enterprise/bin/unicorn -c #{rails_root}/system/unicorn.config -E #{rails_env} -D"
 
  # QUIT gracefully shuts down workers then master
